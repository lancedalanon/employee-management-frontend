...
// Validation schema for employment information (Step 3)
...
const Registration: React.FC = () => {
  ...
  // Form handling using React Hook Form and Yup
  const {
    register,
    handleSubmit,
    formState: { errors },
    ...
    resolver: yupResolver(getValidationSchema()), // Set validation schema based on step
    mode: 'onChange',
  });
          ...
          {step === 1 && (
            <>
              ...
              <button
                type="button"
                onClick={handleNext}
                className="w-full px-4 py-2 mt-4 text-white bg-indigo-500 rounded-md hover:bg-indigo-600 focus:ring-4 focus:ring-indigo-200"
              >
                Next
              </button>
            </>
          ...
          {step === 2 && (
            <>              
              ...
              <button
                type="button"
                onClick={handleBack}
                className="w-full px-4 py-2 mb-4 text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300 focus:ring-4 focus:ring-gray-200"
              >
                Back
              </button>
